...
class HubertEncoder(FairseqEncoder):
    def __init__(self, cfg: HubertDiarConfig):
        ...
        arg_overrides = {
            ...
            "spk_aware": cfg.spk_aware,
            "spk_embed": cfg.spk_embed,
            "spk_method": cfg.spk_method,
            "spk_layers": cfg.spk_layers,
            "cat_layers": cfg.cat_layers,
            "keep_spk_layers": cfg.keep_spk_layers,
            "init_linear": cfg.init_linear,
            "ln_after_adapt": cfg.ln_after_adapt,
            "cln": cfg.cln,
            "cln_bias": cfg.cln_bias,
            "cattn": cfg.cattn,
    ...
    def forward(self, source, padding_mask, embed=None, tbc=True, **kwargs):
